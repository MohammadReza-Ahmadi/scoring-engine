...
class ScoreCalculationService:
    ...
    def calculate_user_done_trades_score(self, user_id: long, reset_cache=False):
        ...
        score += rds.get_score_of_rules_done_trades_average_delay_days(done_trade.total_delay_days)
        done_trades_score += score
        print('score= {}, doneTrades:[total_delay_days]= {}'.format(score, done_trade.total_delay_days))
