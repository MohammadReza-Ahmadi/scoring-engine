...
class RedisCachingRulesHistories:
    ...
    def cache_rules(self):
        ...
        s = self.get_score_of_rules_membership_days_counts_h5(False)
        print(s)
    ...
    def cache_rules_history_membership_days_counts_h5(self):
        ...
        print('caching membership_days_counts_h5 are done.')

    def cache_rules_done_past_due_trades_of_last_3_months_h6(self):
        if self.recreate_caches:
        ...
        print('caching rules_done_past_due_trades_of_last_3_months_h6 are done.')

    def cache_rules_done_past_due_trades_between_last_3_to_12_months_h7(self):
        if self.recreate_caches:
        ...
        print('caching rules_done_past_due_trades_between_last_3_to_12_months_h7 are done.')
    ...
    def cache_rules_profile_recommended_to_others_counts_h8(self):
        ...
        print('caching rules_profile_recommended_to_others_counts_h8 are done.')
    ...
    def cache_rules_profile_star_counts_avgs_h9(self):
        ...
        print('caching rules_profile_star_counts_avgs_h9 are done.')
