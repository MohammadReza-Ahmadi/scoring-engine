...
from app.core.constants import ALL_USERS_AVERAGE_UNFIXED_RETURNED_CHEQUES_AMOUNT, IDENTITIES_SCORE, HISTORIES_SCORE, VOLUMES_SCORE, \
...
def calculate_score(scenarios_dicts: [], user_id: int = None):
    ...
    for scn_dict in scenarios_dicts:
        ...
        p.score = cs.calculate_user_profile_score(user_id=0, profile_object=p)
        ds.insert_profile(p)
